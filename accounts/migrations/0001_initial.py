# Generated by Django 3.1.6 on 2021-02-14 09:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=17, unique=True, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+7747 77 99'. Up to 14 digits allowed.", regex='^\\+?1?\\d{9,14}$')])),
